...
return [
    ...
    'auth' => [
        'enabled' => true,       // چون API شما احراز هویت دارد
        'default' => true,       // یعنی همه‌ی APIها پیش‌فرض authenticated هستند
        'in' => AuthIn::BEARER->value,   // نوع Auth → Bearer Token
        'name' => 'Authorization',        // هدر استاندارد Bearer Token
        'use_value' => env('SCRIBE_AUTH_KEY'), // توکن تست برای Try It Out
        'placeholder' => 'Bearer {YOUR_TOKEN}', // چیزی که کاربر در مستندات می‌بیند
        'extra_info' => 'To use this API, send your token in the Authorization header as a Bearer token.',
